...
class LearningMaterialController extends Controller
{
    ...
    public function index()
    {
        ...
        $learningMaterial = LearningMaterial::with(['learningMaterial', 'departments'])
            ->paginate(10);
    ...
    public function create()
    {
        ...
        $learningMaterial = LearningMaterial::with(['learningProvider', 'department'])->get();
    ...
    public function show(LearningMaterial $learningMaterial, Request $request)
    {
        ...
        return Inertia::render('learningProvider/Show', [
            'learning$learningMaterial' => $learningMaterial->load(['learningMaterial', 'department']),
    ...
    public function update(
        ...
        $learningMaterial->update(array_merge(
            $data,
            [
                'updated_by' => auth()->id(),
                'updated_at' => now(),
