	...
	<AppLayout title="Companies" :breadcrumbs="breadcrumbs">
		...
		<div class="px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
			<div class="flex justify-between items-center mb-6">
				...
				<Link href="/companies/create" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md shadow-sm">
					+ New Company
				</Link>
			</div>
			...
			<div class="overflow-x-auto">
				<table class="min-w-full border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 rounded-md shadow-sm">
					...
					<tbody>
						<tr v-for="company in companies" :key="company.id" class="hover:bg-gray-50 dark:hover:bg-gray-700 transition">
